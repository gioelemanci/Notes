...
\[
    \mathrm{SO}^+(1,3) \sim \mathrm{SU}(2)_L \times \mathrm{SU}(2)_R.
\]
...
The infinitesimal generators of \(\mathrm{SL}(2,\mathbb{C})\) correspond to those of the Lorentz algebra and are represented as\footnote{Where \(\overline{\sigma}^{\mu} = \left(\mathbb{I}, -\bs{\sigma} \right)\).}\QUESTION{
    Should we define bar-sigma like this or with opposed sign? Later we use the definition positive identity and negative sigmas.}
\[
    \left\{
    \begin{aligned}

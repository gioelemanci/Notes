...
\[
    \hat{\mathbf{P}}^i = \int \frac{\mathrm{d}^3 \mathbf{p}}{(2\pi)^3} p^i \hat{a}^{\dagger}_{\mathbf{p}} \hat{a}_{\mathbf{p}} \quad \text{or, more compactly} \quad \hat{\mathbf{P}} = \int \frac{\mathrm{d}^3 \mathbf{p}}{(2\pi)^3} \mathbf{p}\, \hat{a}^{\dagger}_{\mathbf{p}} \hat{a}_{\mathbf{p}}.
\]

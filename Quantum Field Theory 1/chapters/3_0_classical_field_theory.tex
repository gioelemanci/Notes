...
Finally, for strictly invariant Lagrangians (\(\delta \mathcal{L} = 0\)), the term \(K^{\mu}\) vanishes identically, yielding the general expression for the conserved current:
\begin{equation}

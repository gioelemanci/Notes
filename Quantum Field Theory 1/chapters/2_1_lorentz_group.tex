...
\]
Thus we have six independent generators and six indipendent and continuous parameters to describe our Lie group, which topologically can be addressed to as \(\mathbb{R}_3 \times S_3 / \mathbb{Z}_2\), highlighting how the non compactness derive from the unbounded boosts subgroup.
...
\[
    ...
    [A_i, B_j] = 0.
\]
This shows explicitly the \textbf{algebra decomposition into a direct sum of two commuting algebras}.

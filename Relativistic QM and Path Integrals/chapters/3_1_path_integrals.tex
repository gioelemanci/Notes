...
\[
    S[\phi] = - \frac{1}{2} \phi^i K_{ij} \phi^j.
\]
Denoting \(\mathrm{D}\phi = \frac{\mathrm{d}^n \phi}{(-i2\pi)^{\tfrac{n}{2}}}\), setting \(\hbar = 1\) for simplicity, and using the gaussian result in eq.(57), one calculates formally the path integral with sources
\[
